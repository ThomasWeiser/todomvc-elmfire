              ...
              {case "AddItem":
                 return {ctor: "_Tuple2"
                        ,_0: _U.replace([["addField"
                                         ,""]],
                        model)
                        ,_1: $String.isEmpty($String.trim(model.addField)) ? $Effects.none : effectItems($ElmFire$Op.push({_: {}
                                                                                                                          ,completed: false
                                                                                                                          ,title: $String.trim(model.addField)}))};
                 case "CheckAllItems":
                 return {ctor: "_Tuple2"
                        ,_0: model
                        ,_1: effectItems(A2($ElmFire$Op.map,
                        $ElmFire$Op.parallel,
                        F2(function (_v34,item) {
                           return function () {
                 ...
                 return {ctor: "_Tuple2"
                        ,_0: model
                        ,_1: effectItems($ElmFire$Op.remove(action._0._0))};
                 case "EditAddField":
                 return {ctor: "_Tuple2"
                        ,_0: _U.replace([["addField"
                                         ,action._0._0]],
                 ...
                 return {ctor: "_Tuple2"
                        ...
                        model)
                        ,_1: function () {
                           var _v42 = model.editingItem;
                           switch (_v42.ctor)
                           {case "Just":
                              switch (_v42._0.ctor)
                                {case "_Tuple2":
                                   return _U.eq(action._0._0,
                                     _v42._0._0) ? $String.isEmpty($String.trim(_v42._0._1)) ? effectItems($ElmFire$Op.remove(action._0._0)) : effectItems(A2($ElmFire$Op.update,
                                     action._0._0,
                                     $Maybe.map(function (item) {
                                        return _U.replace([["title"
                                                           ,$String.trim(_v42._0._1)]],
                                        item);
                                     }))) : $Effects.none;}
                                break;}
                           return $Effects.none;
